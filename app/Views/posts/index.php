    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image" style="align-self: center;">
          <img src="/assets/images/profile.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Achmad Romadoni</a>
          <span style="color:white">1917051055</span>
        </div>
      </div>
            ...
            <table class="table table-striped text-center">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?= $post['kategori']; ?></td>
                  <td><?= $post['author']; ?></td>
                  <td class="d-flex flex-row w-100">
                    <a href="<?= ("/admin/posts/edit/".$post['post_id']); ?>" class="btn btn-warning"><i class="fas fa-edit"></i>Edit</a>
                    <form action="/admin/posts/<?= $post['post_id']; ?>" method="POST" class="d-inline ms-2">
